...
public class MdJadePlugin implements IWailaPlugin {
    ...
    public void registerClient(IWailaClientRegistration registration) {
        ...
        registration.registerBlockIcon(AttachmentTooltipProvider.INSTANCE, PipeBlock.class);
        registration.registerBlockComponent(AttachmentTooltipProvider.INSTANCE, PipeBlock.class);
